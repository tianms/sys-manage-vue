    ...
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;" >
          <img src="~@/assets/img/rr_logo_mody.png" class="nb-lg" style="width: 156px;height: 52px;"/>
        </a>
        <a class="site-navbar__brand-mini" href="javascript:;"><img src="~@/assets/img/rr_logo_mini.jpg" style="width: 30px;"/></a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      <el-menu class="site-navbar__menu" mode="horizontal">
        <el-menu-item class="site-navbar__switch" index="0" @click="switchSidebarCollapseHandle()">
          <icon-svg name="fa-bars"></icon-svg>
        </el-menu-item>
      </el-menu>
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom" size="medium">
            <span class="el-dropdown-link">
              <img src="~@/assets/img/png-user.png" :alt="$store.state.user.name">
